const questionsAndAnswers = [
    ...
    { question: "Кто тебя создал?", answer: "Меня создал Романенко Артем Васильевич" },
    { question: "Для чего тебя создали?", answer: "Я создан что бы демонтрировать навыки программирования" },
    { question: "Чем увлекаеться Артем", answer: "Артем увлекаеться программированием Arduino а еще у него есть сайт https://wikicod.ru" },
];
